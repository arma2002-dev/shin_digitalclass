                ...
                <div className="w-24 h-24 rounded-2xl overflow-hidden mb-6 ring-4 ring-blue-50 dark:ring-slate-800 bg-slate-100 dark:bg-slate-800 flex items-center justify-center">
                  {INSTRUCTOR.image ? (
                    <img 
                      ...
                      onLoad={() => console.log("Image loaded successfully:", INSTRUCTOR.image)}
                      onError={(e) => {
                        console.error("Image failed to load:", INSTRUCTOR.image, e);
                        const target = e.target as HTMLImageElement;
                        target.src = "https://picsum.photos/seed/instructor/400/400";
                      }}
                    />
                  ) : (
